...
Web2.0我们常用**搜索引擎**获取自己需要的信息，即使现在，是现在主流的信息资料获取途径。但，使用搜索引擎的背景是目标明确的情况下，同时也需要将目标转化为搜索🔍关键字，并在巨量的结果集下筛选信息会浪费大量的时间、资源。
...
数据又可分为**显示数据**和**隐式数据**，显示数据即用户的购买、退货、打分、点赞、收藏、评论等形式，直接表达自己的喜好。隐式数据可能使隐形的，需要深度挖掘，如：快进、重复观看、浏览、点击等等。
